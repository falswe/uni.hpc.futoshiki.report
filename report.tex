...
\input{sections/02_sequential_algorithm.tex}
\input{sections/03_parallel_implementation.tex}
\input{sections/04_experimental_evaluation.tex}
\input{sections/05_conclusion.tex}
\input{sections/06_future_works.tex}
